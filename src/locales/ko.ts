const ko = {
  ...
  popupHico: {
    ...
    hico12: '12줄 추가',
    hico12Price: '49만원',
    hicoComboThread: '필러 + 실리프팅',
    hicoComboThreadPrice: '59만원',
    liftingTitle: '리프팅',
    liftingPdo: 'PDO 8줄 + 2줄 추가',
    liftingPdoPrice: '47만원',
    liftingPcl: 'PCL 6줄 + 2줄 추가',
    liftingPclPrice: '59만원',
    liftingJamber: '잼버실 6줄 + 2줄',
    liftingJamberPrice: '59만원',
    liftingForehead: '이마 8줄 + 2줄',
    liftingForeheadPrice: '79만원',
    skinTitle: '피부 EVENT',
    skinDerma: '더마톡신 (얼굴전체)',
