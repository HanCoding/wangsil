const ko = {
  ...
  popupHico: {
    ...
    ariaLabel: '왕실의원 7월 이벤트 안내 — 왕실리프팅·피부·눈성형·동안성형·필러',
    tabLabel: '리프팅',
    wangsilTitle: '왕실리프팅',
    wangsilPcl: 'PCL + PDO 복합 실리프팅 프로그램',
    wangsilPclDesc: 'PCL 콘셀티나 6줄 + PDO 민트스트롱 4줄',
    wangsilPclPrice: '68만원',
    wangsilPdoJamber: 'PDO + 잼버 복합 실리프팅 프로그램',
    wangsilPdoJamberDesc: 'PDO 민트스트롱 8줄 + 잼버실 4줄',
    wangsilPdoJamberPrice: '78만원',
    wangsilJamber: '잼버실 위주 복합 실리프팅 프로그램',
    wangsilJamberDesc: 'PDO 민트스트롱 4줄 + 잼버실 8줄',
    wangsilJamberPrice: '88만원',
    skinTitle: '피부 EVENT',
    skinDerma: '더마톡신 (얼굴전체)',
    skinDermaPrice: '99,000원',
    skinIpl: 'IPL',
    skinIplPrice: '39,000원',
    skinFraxel: '프락셀',
    skinFraxelPrice: '99,000원',
    eyeTitle: '눈성형 EVENT',
    eyeFatRepo: '눈밑지방재배치',
    eyeFatRepoPrice: '70만원',
    eyeBrowLift: '눈썹거상술',
    eyeBrowLiftPrice: '70만원',
    antiagingTitle: '동안성형 EVENT',
    antiagingFacelift: '안면거상',
    antiagingFaceliftPrice: '280만원',
    antiagingThread: '실리프팅',
    antiagingThreadSingle: '한부위',
    antiagingThreadSinglePrice: '50만원부터',
    antiagingThreadFull: '얼굴전체',
    antiagingThreadFullPrice: '99만원',
    antiagingThreadSilhouette: '실거상',
    antiagingThreadSilhouettePrice: '200만원',
    antiagingCombo: '안면거상 + 실리프팅',
    antiagingComboPrice: '맞춤 상담',
  ...
  popupSummer: {
    ...
    card1Tag: '이마주름 & 처짐도',
    card1Title: '탄탄하게!',
    card1Sub: '흉터 없이 리프팅하자!',
    card1Note: '※ 재수술 제외',
    foreheadBasic: '이마거상술(절개)',
    foreheadBasicOld: '300만원',
    foreheadBasicNew: '190만원',
    foreheadUpper: '이마거상술(절개)+상안검',
    foreheadUpperOld: '400만원',
    foreheadUpperNew: '260만원',
    foreheadFull: '이마거상술(절개)+상안검+하안검',
    foreheadFullOld: '500만원',
    foreheadFullNew: '340만원',
    card2Title: '10년 젊어지는 동안수술',
    card2Note: '※ 선착순 10명 / 재수술 제외',
    miniLift: '미니거상술',
    miniLiftOld: '300만원',
    miniLiftNew: '190만원',
    browLift: '눈썹거상술',
  ...
  popupFiller: {
    ...
    shoulderFiller: '어깨필러',
    shoulderFillerPrice: '150만원~200만원',
    handFiller: '손등필러',
    handFillerPrice: '50만원~80만원',
    hipFiller: '힙필러',
    hipFillerPrice: '180만원~200만원',
    taxNote: '★ 부가세 별도',
    hideToday: '오늘은 더 보지 않기',
    close: '닫기 ✕',
  },
